...
class Course():
    ...
    # 1. Method to print the head office location
    def location(self):
        print("Our head office is located in", self.head_office)

# 2. Subclass of Course
class OOPCourse(Course):
    ...
    # 4. Method to print course details
    def trainer_details(self):
        print(f"This training is about {self.description} and it is delivered by our trainer {self.trainer}")

    # 5. Method to print ID
    def show_course_id(self):
        print("The course ID is:", self.ID)

# 6. Create object and call methods to print data
course_1 = OOPCourse()
